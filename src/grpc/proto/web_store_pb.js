...
proto.data.AddressRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    address3: jspb.Message.getFieldWithDefault(msg, 11, ""),
    address4: jspb.Message.getFieldWithDefault(msg, 12, "")
  };
